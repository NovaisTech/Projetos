# 🛠️ NovaisTech: Oficina & Laboratório de Projetos

Bem-vindo à minha **Oficina de Desenvolvimento de Software**! 🚀

Este repositório é um espaço dedicado à experimentação prática, engenharia de software e criação de projetos autorais completos. Aqui, a teoria se transforma em código real — desde jogos retrô e APIs modernas até ferramentas de dados e automação —, explorando múltiplas linguagens e arquiteturas.

---

## 🧭 Filosofia da Oficina

- **Múltiplas Tecnologias**: Projetos desenvolvidos em Python, JavaScript, SQL, APIs RESTful e o que mais a curiosidade técnica demandar.
- **Aprendizado Ativo (Mão na Massa)**: Cada linha de código é digitada, compreendida e estruturada com arquitetura limpa.
- **Documentação Explicativa**: Cada projeto conta com guias de estudo detalhados e diários de bordo para consulta e compartilhamento de conhecimento.
...
- 🎨 **Frontend**: Interface construída do zero em **HTML5**, **CSS Pixel Art** e efeitos sonoros gerados via Web Audio API.
